    ...
    <nav className="border-rose-50 bg-white-50">
      <div className="max-w-screen-xl flex flex-row items-center justify-between mx-auto p-4">
        ...
        <div className=" block w-auto " id="navbar-solid-bg flex">
          <button className="flex font-medium m-3 rounded-lg  space-x-8 rtl:space-x-reverse mr-10 border-2 border-purple-400 bg-transparent  p-1 py-2 px-3 text-rose-950 ">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 mr-1">
